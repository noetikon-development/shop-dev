...
export const ADMIN_ROUTES: AdminRoute[] = [
  ...
  },
  {
    ...
    label: "Seller orders",
    description: "Marketplace order lines across every seller — status, totals, and commission. Read-only.",
    accepts: ["view_orders", "manage_orders"],
    emptyLabel: "No seller orders yet.",
    live: true,
  },
  {
    path: "/admin/returns",
  ...
  },
  {
    path: "/admin/offers",
    label: "Offers",
    description: "Every seller's catalog listings, across every seller. Read-only.",
    group: "admin",
    accepts: ["manage_settings", "manage_content"],
  ...
  },
  {
    ...
    label: "Settlements",
    description: "Record bookkeeping payouts to third-party sellers. No real transfer — you record payments made outside the system.",
    group: "admin",
    accepts: ["manage_payments"],
