...
export function MediaUploader() {
  ...
  return (
    <form ref={ref} action={formAction} className="grid gap-4 sm:grid-cols-[1fr_200px_auto] sm:items-end">
      <FormField label="File" htmlFor="media-file" hint="PNG, JPG, WEBP, GIF, SVG or PDF · up to 8 MB">
        <input
          id="media-file"
          name="file"
          type="file"
